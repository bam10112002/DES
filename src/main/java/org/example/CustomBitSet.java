...
//    }
    ...
    public @NonNull CustomBitSet xor(@NonNull CustomBitSet bits) throws Exception {
        if (len != bits.len)
     ...
     * @throws Exception
     */
    public @NonNull CustomBitSet concat(@NonNull CustomBitSet bitSet) throws Exception {
        if (len == 0)
